...
import {Button, Paper, SvgIcon, Grid, Table, TableBody, TableRow, TableHead, TableCell, Divider} from '@material-ui/core'
      ...
      <div>
        ...
        <Grid container spacing={24} className={classes.container}>
            ...
            <Grid className={classes.header} direction='row' item xs={12}>
                ...
                <Typography variant='h5'>Bowling Stats</Typography>
                <Button
            ...
            <Grid item xs={6}>
                <img className={classes.figure} src={Figure}></img>
            </Grid>
        ...
        <Grid className={classes.divider} xs={12}>
                <Divider />
        </Grid> 
        <Grid container alignContent='baseline' className={classes.footer} xs={12}>
                <Grid item xs={3}>
                    <img className={classes.footerLogo} src={Logo}></img>
                </Grid>
                <Grid direction='column' justify='space-evenly' xs={3}>
                    <IconButton>
                ...
                <Grid item xs={3}></Grid>
                <Grid direction='column' justify='space-evenly' container xs={3}>
